...
export const translations: Translation = {
  en: {
    ...
    // SoilXpert specific translations
    ...
    yieldSales: "Yield Sales",
    farmerRegistration: "Farmer Registration",
    registerToGetStarted: "Register to get started with SoilXpert services",
    yourName: "Your Name",
    ...
    location: "Location",
    enterLocation: "City, State",
    farmSize: "Farm Size",
    enterFarmSize: "Size in acres",
    farmDetails: "Farm Details",
    additionalDetails: "Tell us more about your farm (current crops, challenges, etc.)",
    farmDetailsDescription: "This information helps us provide better recommendations",
    registerAndContinue: "Register & Continue",
    
    soilTestSubmission: "Soil Test Submission",
    submitSoilSample: "Submit your soil sample data for analysis",
    manualEntry: "Manual Entry",
    uploadResults: "Upload Results",
    soilPh: "Soil pH",
    phRange: "Range: 0-14, 7 is neutral",
    ...
    dragAndDropFile: "Drag and drop your file here, or click to browse",
    ...
    aiGeneratedInsights: "AI-generated insights for your soil",
    soilQualityAnalysis: "Soil Quality Analysis",
    ...
    neutral: "Neutral",
    alkaline: "Alkaline",
    cropRecommendations: "Crop Recommendations for Maximum Profitability",
    profitability: "Profitability",
    suitability: "Suitability",
    profitabilityScore: "Profitability",
    suitabilityForYourSoil: "Suitability for your soil",
    suggestedFarmingPractices: "Suggested Farming Practices",
    noDataAvailable: "No Data Available",
    pleaseSubmitSoilTest: "Please submit your soil test data to generate a report.",
    proceedToYieldSales: "Proceed to Yield Sales",
    
    listYourYield: "List Your Yield",
    listYourProducts: "List your agricultural products for buyers",
    ...
    describeYourProduct: "Describe your product, quality, etc.",
    organicProduct: "This is an organic product",
    ...
    noInquiriesYet: "No inquiries yet. Once you list your products, buyers will be able to contact you.",
    ...
    edit: "Edit",
    delete: "Delete",
    noListingsYet: "You haven't listed any products yet. Use the form above to list your agricultural products for sale.",
    organic: "Organic"
  },
  hi: {
    // Navigation
    ...
    // SoilXpert specific translations for Hindi
    soilxpertHeroTitle: "AI अंतर्दृष्टि के साथ अपनी मिट्टी की क्षमता को अनलॉक करें",
    soilxpertHeroDescription: "AI-संचालित विश्लेषण का उपयोग करके उन्नत मिट्टी परीक्षण, व्यक्तिगत फसल सिफारिशें और उपज भविष्यवाणी।",
    register: "पंजीकरण",
    soilTest: "मिट्टी परीक्षण",
    soilReport: "मिट्टी रिपोर्ट",
    yieldSales: "उपज बिक्री",
    farmerRegistration: "किसान पंजीकरण",
    registerToGetStarted: "SoilXpert सेवाओं के साथ शुरू करने के लिए पंजीकरण करें",
    yourName: "आपका नाम",
    ...
    location: "स्थान",
    enterLocation: "शहर, राज्य",
    farmSize: "खेत का आकार",
    enterFarmSize: "एकड़ में आकार",
    farmDetails: "खेत का विवरण",
    additionalDetails: "अपने खेत के बारे में अधिक बताएं (वर्तमान फसलें, चुनौतियां, आदि)",
    farmDetailsDescription: "यह जानकारी हमें बेहतर सिफारिशें प्रदान करने में मदद करती है",
    registerAndContinue: "पंजीकरण करें और जारी रखें"
  },
  ta: {
  ...
  kn: {
    ...
    // SoilXpert specific translations for Kannada
    soilxpertHeroTitle: "ಎಐ ಒಳನೋಟಗಳೊಂದಿಗೆ ನಿಮ್ಮ ಮಣ್ಣಿನ ಸಾಮರ್ಥ್ಯವನ್ನು ಅನ್‌ಲಾಕ್ ಮಾಡಿ",
    soilxpertHeroDescription: "ಎಐ-ಆಧಾರಿತ ವಿಶ್ಲೇಷಣೆಯನ್ನು ಬಳಸಿ ಆಧುನಿಕ ಮಣ್ಣು ಪರೀಕ್ಷೆ, ವೈಯಕ್ತಿಕ ಬೆಳೆ ಶಿಫಾರಸುಗಳು ಮತ್ತು ಇಳುವರಿ ಮುನ್ಸೂಚನೆ.",
    register: "ನೋಂದಣಿ",
    soilTest: "ಮಣ್ಣು ಪರೀಕ್ಷೆ",
    soilReport: "ಮಣ್ಣು ವರದಿ",
    yieldSales: "ಇಳುವರಿ ಮಾರಾಟ",
